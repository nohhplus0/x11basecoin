...
Only requiring some minor changes is x11basecoin.cpp.
...
Changes to x11basecoin.cpp
----------------------
x11basecoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
