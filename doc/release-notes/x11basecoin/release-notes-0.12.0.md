...
X11BaseCoin Core version 0.12.0 is now available from:

  https://x11basecoinpay.io/downloads

Please report bugs using the issue tracker at github:

  https://github.com/x11basecoinpay/x11basecoin/issues
...
backwards-compatible with pre-0.12 versions of X11BaseCoin Core or other software:
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/x11basecoin/).
