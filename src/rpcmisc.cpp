...
Value getinfo(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"darksend_balance\": xxxxxx, (numeric) the anonymized x11basecoin balance of the wallet\n"
            ...
            "  \"paytxfee\": x.xxxx,         (numeric) the transaction fee set in x11basecoin/kb\n"
            "  \"relayfee\": x.xxxx,         (numeric) minimum relay fee for non-free transactions in x11basecoin/kb\n"
...
Value validateaddress(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress \"x11basecoinaddress\"\n"
            "\nReturn information about the given x11basecoin address.\n"
            "\nArguments:\n"
            "1. \"x11basecoinaddress\"     (string, required) The x11basecoin address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,         (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"x11basecoinaddress\", (string) The x11basecoin address validated\n"
...
#ifdef ENABLE_WALLET
        // Case 1: X11BaseCoin address and we have full public key:
...
Value createmultisig(const Array& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 2)
    {
        string msg = "createmultisig nrequired [\"key\",...]\n"
            ...
            "2. \"keys\"       (string, required) A json array of keys which are x11basecoin addresses or hex-encoded public keys\n"
            "     [\n"
            "       \"key\"    (string) x11basecoin address or hex-encoded public key\n"
            "       ,...\n"
            "     ]\n"
...
Value verifymessage(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage \"x11basecoinaddress\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"
            "\nArguments:\n"
            "1. \"x11basecoinaddress\"  (string, required) The x11basecoin address to use for the signature.\n"
