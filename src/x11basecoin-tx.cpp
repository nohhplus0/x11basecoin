...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("X11BaseCoin Core x11basecoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  x11basecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded x11basecoin transaction") + "\n" +
              "  x11basecoin-tx [options] -create [commands]   " + _("Create hex-encoded x11basecoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded x11basecoin transaction
