...
#if defined(NDEBUG)
# error "X11BaseCoin cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in x11basecoinbits) are considered zero fee (for relaying and mining)
...
void ThreadScriptCheck() {
    RenameThread("x11basecoin-scriptch");
