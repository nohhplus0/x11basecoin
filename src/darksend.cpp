...
/* *** BEGIN DARKSEND MAGIC - X11BASECOIN **********
    Copyright (c) 2014-2015, X11BaseCoin Developers
        eduffield - evan@x11basecoinpay.io
        udjinm6   - udjinm6@x11basecoinpay.io
*/
    ...
    if(fMasterNode) {
        ...
        BOOST_FOREACH(const CTransaction& txCollateral, vecSessionCollateral) {
            ...
            /*
                ...
                allow endless transaction that would bloat X11BaseCoin and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("x11basecoin-darksend");
