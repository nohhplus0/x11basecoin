    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("X11BaseCoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (about)
    {
        setWindowTitle(tr("About X11BaseCoin Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  x11basecoin-qt [" + tr("command-line options") + "]                     " + "\n";
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("X11BaseCoin Core is shutting down...") + "<br /><br />" +
