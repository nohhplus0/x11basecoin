...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("X11BaseCoin Core"),
     ...
     * override -datadir in the x11basecoin.conf file in the default data directory
     * (to be consistent with x11basecoind behavior)
     */
    if(dataDir != getDefaultDataDirectory())
