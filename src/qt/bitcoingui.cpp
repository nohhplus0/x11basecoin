...
void BitcoinGUI::createActions(const NetworkStyle *networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a X11BaseCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and x11basecoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About X11BaseCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about X11BaseCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for X11BaseCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your X11BaseCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified X11BaseCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a x11basecoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the X11BaseCoin Core help message to get a list with possible X11BaseCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("X11BaseCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to X11BaseCoin network", "", count));
}
...
{
    QString strTitle = tr("X11BaseCoin Core"); // default title
